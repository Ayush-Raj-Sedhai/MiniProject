...
<body id="back">
    ...
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto" >All Student List</a></h1>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="viewall.php" >View All Students</a></li>
    ...
    <div style="text-align:center">
        <h3 >Here is The List Of All Student</h3>
   ...
   <table style="width:100%;"> 
        ...
        <thead>
            <tr>
                ...
                <th style="width:10%;"><h4>RollNo</h4></th>
                <th style="width:20%;"><h4>Name</h4></th>
                <th style="width:10%;"><h4>Admission Number</h4></th>
        ...
        <tbody>
			...
			if(isset($_POST['sub']))
				...
				{
					echo "<tr><td colspan='7' class='box-sm'><h4 class='page-header'>No Student Found</h4></td></tr>";
				}
