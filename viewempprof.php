 ...
 <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,700,700i|Montserrat:300,400,500,700" rel="stylesheet">
    ...
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">Admin Add Student</a></h1>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="viewall.php">View All Student</a></li>
...
<body id="back">
    ...
    <div class="col-md-5 box" style="margin-left:80px;">
        ...
        <table class="table box-sm">
            <tr><td><label>Admission Number</label></td><td><span id="uname"><?php echo $uname ?></span></td></tr>
    ...
    <div class="col-md-3 box" style="margin-left:80px;margin-bottom:40px;">
        ...
        <table class="table box-sm">
            <tr><td><label>Type of Student</label></td><td><span id="type"><?php echo $type ?></span></td></tr>
